...
const Addworkexperience : React.FC<ModalProps> = ({isOpen, onClose,intialValues,onAddHandler,onUpdateHandler}) =>  
    {
              ...
              {({ setFieldValue,values }) => (
                <Form>
                    ...
                    <div>
                     ...
                     <div>
                     <label>Role *</label>
                     <Input style={OverrideCss} defaultValue={intialValues.role}  name='role' onChange={(e) => setFieldValue('role', e.target.value)} />
                     </div>
                     <div>
                     <label>Role Description</label>
                     <Input style={OverrideCss} defaultValue={intialValues.roleDescription} name='roleDescription' onChange={(e) => setFieldValue('roleDescription', e.target.value)} />
                     </div>
                     <FlexDiv>
                     <div>
