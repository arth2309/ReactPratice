...
const Addworkexperience: React.FC<ModalProps> = ({
  onClose,
  intialValues,
  onAddHandler,
  onUpdateHandler,
  ...
  return (
    <ModalOverlay onClick={onClose}>
      <ModalContent onClick={(e) => e.stopPropagation()}>
        <ModalHeader>
          <Title>
            {intialValues.id > 0 ? "Update" : "Add"} Work Experience
          </Title>
              ...
              <Form>
                <FormDiv>
                  ...
                  <div>
                    <label>Role *</label>
                    <Input
                      defaultValue={intialValues.role}
                      name="role"
                  ...
                  <div>
                    ...
                    <Input
                      defaultValue={intialValues.roleDescription}
                      name="roleDescription"
                      onChange={(e) =>
                        setFieldValue("roleDescription", e.target.value)
                      }
                    />
                  </div>
                  <FlexDiv>
