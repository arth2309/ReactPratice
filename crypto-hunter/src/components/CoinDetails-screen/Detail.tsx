...
const Detail = (props : any) => {
    ...
    return (
        <>
                ...
                <div className='my-1'><strong className='text-success'>Rank :</strong>  {item.market_cap_rank}</div>
                <div className='my-1'><strong className='text-success'>Current price :</strong> {item.current_price}</div>
                <div className='my-1'><strong className='text-success'>Market Cap :</strong> {item.market_cap}</div>
